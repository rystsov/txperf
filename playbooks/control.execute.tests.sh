...
# echo "$(date) test_suite_multi_write_64_kafka" >> log
# ansible-playbook playbooks/test.suite.yml --key-file id_ed25519 -e suite_path=test_suite_multi_write_64_kafka.json
# fetch_logs "results/multi_write-kafka-64"
